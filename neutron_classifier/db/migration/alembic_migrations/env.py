...
# Derived from neutron/db/migration/alembic_migrations/env.py
...
NAME_PREFIX = "idx_autoinc_"
MYSQL_ENGINE = None
CLASSIFIER_VERSION_TABLE = 'alembic_version_classifier'
...
def include_object(object_, name, type_, reflected, compare_to):
    if type_ == 'table' and name in external.TABLES:
        return False
    elif type_ == 'index' and reflected and name.startswith(NAME_PREFIX):
...
def run_migrations_offline():
    ...
    kwargs['version_table'] = CLASSIFIER_VERSION_TABLE
...
def run_migrations_online():
    ...
    with DBConnection(neutron_config.database.connection, connection) as conn:
        context.configure(
            ...
            version_table=CLASSIFIER_VERSION_TABLE,
