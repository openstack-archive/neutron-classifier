...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('cg_parent_id', sa.String(length=36), sa.ForeignKey(
                  "classification_groups.id"), primary_key=True),
        sa.Column('classification_id', sa.String(length=36), sa.ForeignKey(
    ...
    op.create_table(
        ...
        sa.Column('cg_parent_id', sa.String(length=36), sa.ForeignKey(
                  "classification_groups.id"), primary_key=True),
        sa.Column('cg_child_id', sa.String(length=36), sa.ForeignKey(
                  "classification_groups.id"), primary_key=True))
