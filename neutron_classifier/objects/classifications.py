...
class IPV6Classification(ClassificationBase):
    ...
    fields = {
        'traffic_class': obj_fields.IntegerField(nullable=True),
        'traffic_class_mask': obj_fields.IntegerField(nullable=True),
        'length': obj_fields.IntegerField(nullable=True),
        'next_header': obj_fields.IntegerField(nullable=True),
        'hops': obj_fields.IntegerField(nullable=True),
        'src_addr': obj_fields.StringField(nullable=True),
        'dst_addr': obj_fields.StringField(nullable=True),
    }
...
class EthernetClassification(ClassificationBase):
    ...
    fields = {
        'preamble': obj_fields.IntegerField(nullable=True),
        'src_addr': obj_fields.StringField(nullable=True),
        'dst_addr': obj_fields.StringField(nullable=True),
        'ethertype': obj_fields.StringField(nullable=True),
    }
...
class UDPClassification(ClassificationBase):
    ...
    fields = {
        'src_port': obj_fields.StringField(nullable=True),
        'dst_port': obj_fields.StringField(nullable=True),
        'length': obj_fields.IntegerField(nullable=True),
        'window_size': obj_fields.IntegerField(nullable=True),
    }
...
class TCPClassification(ClassificationBase):
    ...
    fields = {
        ...
        'flags': obj_fields.IntegerField(nullable=True),
        'flags_mask': obj_fields.IntegerField(nullable=True),
        'window': obj_fields.IntegerField(nullable=True),
        'data_offset': obj_fields.IntegerField(nullable=True),
        'option_kind': obj_fields.IntegerField(nullable=True),
    }
