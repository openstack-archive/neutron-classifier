...
NETWORKING_CCF_PATH=$GATE_DEST/networking-classifier
GATE_HOOKS=$NETWORKING_CCF_PATH/networking_classifier/tests/contrib/hooks
...
"dsvm-functional"|"dsvm-fullstack")
    ...
    PROJECT_NAME=networking-classifier
    IS_GATE=True
