...
###            help=('Allows notification of network congestion.'))
        ...
        parser.add_argument(
            '--length-min',
            help=('Minimum length of the Packet, following the IPV6 Header.'))
        parser.add_argument(
            '--length-max',
            help=('Maximum length of the Packet, following the IPV6 Header.'))
        parser.add_argument(
            '--next-header',
        ...
        parser.add_argument(
            '--hops-min',
            help=('Minimum number of hops which the packet may be routed over.'))
        parser.add_argument(
            '--hops-max',
            help=('Maximum number of hops which the packet may be routed over.'))
        parser.add_argument(
            '--src-addr',
...
#        if parsed_args.traffic_class_mask is not None:
#            definition['traffic_class_mask'] = parsed_args.traffic_class_mask
