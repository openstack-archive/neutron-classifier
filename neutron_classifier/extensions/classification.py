...
RESOURCE_ATTRIBUTE_MAP = {
    ...
    'ipv4_classifications':
        classifier_resources.IPV4_CLASSIFICATION_RESOURCE_MAP,
    'ipv6_classifications':
        classifier_resources.IPV6_CLASSIFICATION_RESOURCE_MAP,
    'ethernet_classifications':
        classifier_resources.ETHERNET_CLASSIFICATION_RESOURCE_MAP,
    'udp_classifications':
        classifier_resources.UDP_CLASSIFICATION_RESOURCE_MAP,
    'tcp_classifications':
        classifier_resources.TCP_CLASSIFICATION_RESOURCE_MAP,
}
...
class Classification(api_ext.ExtensionDescriptor):
    ...
    def get_resources(cls):
        ...
        for resource in resources:
            resource.path_prefix = constants.L2_PREFIX
...
class NeutronClassificationPluginBase(service_base.ServicePluginBase):
    ...
    path_prefix = constants.L2_PREFIX
